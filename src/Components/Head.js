...
const Head = () => {
    ...
    return (
        <>
        <div className='grid grid-flow-col items-center  w-[100vw] fixed bg-white z-100'>
            <div className='flex col-span-1 items-center ml-5'>
                <img alt='hamberger ' onClick={() => toogleHandler()} className='h-8 ml-1' src='https://cdn.icon-icons.com/icons2/1875/PNG/512/hamburgermenu_120234.png' />
